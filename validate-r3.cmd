...
"%POWERSHELL_EXE%" -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%scripts\validate-r3.ps1" %*
set "EXIT_CODE=%ERRORLEVEL%"

if not "%EXIT_CODE%"=="0" (
  echo.
  echo R3 validation FAILED with exit code %EXIT_CODE%.
  exit /b %EXIT_CODE%
)

echo.
echo R3 validation PASSED.
exit /b 0
