...
function Write-Stage([string]$Title) {
    ...
    Write-Host ("M16 :: {0}" -f $Title) -ForegroundColor Cyan
    Write-Host ('=' * 78) -ForegroundColor Cyan
}
...
try {
    ...
    Write-Stage 'RESULT'
    Write-Host 'M16 VALIDATION PASSED' -ForegroundColor Green
    ...
    Write-Stage 'RESULT'
    Write-Host 'M16 VALIDATION FAILED' -ForegroundColor Red
