...
```text
baseline Surefire totale       >= 1000
baseline architecture          >= 300
JaCoCo line ratchet            >= 52.0%
JaCoCo branch ratchet          >= 45.0%
...
La baseline globale courante est verrouillée à **52,0% lignes / 45,0% branches**.

Règle d’évolution :

1. une baisse sous 52,0% lignes ou 45,0% branches fait échouer le gate M21 ;
