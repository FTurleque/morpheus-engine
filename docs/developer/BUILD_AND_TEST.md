...
```text
baseline Surefire totale       >= 1150
baseline architecture          >= 310
JaCoCo line ratchet            >= 54.0%
JaCoCo branch ratchet          >= 47.0%
...
La baseline globale courante est verrouillée à **54,0% lignes / 47,0% branches**.

Règle d’évolution :

1. une baisse sous 54,0% lignes ou 47,0% branches fait échouer le gate M21 ;
