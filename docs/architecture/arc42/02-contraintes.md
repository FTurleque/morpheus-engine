...
| CT-6 | Le stockage persistant initial est SQLite via `sqlite-jdbc` **3.53.4.0**, derrière des ports applicatifs | **Imposée** — ADR-0018 | `sqlite-jdbc.version` dans `pom.xml` |
